    ...
    public static MachineRecipe[] all() {
        return new MachineRecipe[] {
            ...
            new MachineRecipe("printed_pistol", IndustrialMachineKind.PROGRAMMABLE_ASSEMBLER,
                ...
                external("ic2:itemmisc", 451, 2), external("railcraft:ingot", 0, 12)),
            new MachineRecipe("city_compact", IndustrialMachineKind.CAR_WORKSHOP,
                ...
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 8), external("railcraft:ingot", 0, 48)),
            new MachineRecipe("frontier_off_roader", IndustrialMachineKind.CAR_WORKSHOP,
                ...
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 10), external("railcraft:ingot", 0, 64)),
            new MachineRecipe("passenger_carrier", IndustrialMachineKind.CAR_WORKSHOP,
                ...
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 16), external("railcraft:ingot", 0, 64)),
            new MachineRecipe("agricultural_tractor", IndustrialMachineKind.CAR_WORKSHOP,
                ...
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 8), external("railcraft:ingot", 0, 56)),
            new MachineRecipe("utility_cart", IndustrialMachineKind.CAR_WORKSHOP,
                ...
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 4), external("railcraft:ingot", 0, 32)),
            new MachineRecipe("scout_atv", IndustrialMachineKind.CAR_WORKSHOP,
                ...
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 6), external("railcraft:ingot", 0, 40)),
            new MachineRecipe("combat_shotgun", IndustrialMachineKind.GUN_FACTORY,
                ...
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 6), external("railcraft:ingot", 0, 32)),
