...
public final class MachineRecipe {
    ...
    public static ItemStack vehicleCrate(String vehicleId) {
        ...
        stack.setTagCompound(tag);
        return MarketEconomy.newCondition(stack);
    }
    ...
    public static MachineRecipe[] all() {
        return new MachineRecipe[] {
            ...
            new MachineRecipe("printed_pistol", IndustrialMachineKind.PROGRAMMABLE_ASSEMBLER,
                null, MarketEconomy.newCondition(external("techguns:pistol", 0)),
                new ItemStack(IndustrialCivilizationCore.PRECISION_FRAME, 4),
                external("ic2:itemmisc", 451, 2), external("railcraft:ingot_steel", 0, 12)),
            new MachineRecipe("city_compact", IndustrialMachineKind.CAR_WORKSHOP,
                null, vehicleCrate("smart_car"), new ItemStack(IndustrialCivilizationCore.PRECISION_FRAME, 16),
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 8), external("railcraft:ingot_steel", 0, 48)),
            new MachineRecipe("frontier_off_roader", IndustrialMachineKind.CAR_WORKSHOP,
                null, vehicleCrate("off_roader"), new ItemStack(IndustrialCivilizationCore.PRECISION_FRAME, 20),
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 10), external("railcraft:ingot_steel", 0, 64)),
            new MachineRecipe("passenger_carrier", IndustrialMachineKind.CAR_WORKSHOP,
                null, vehicleCrate("mini_bus"), new ItemStack(IndustrialCivilizationCore.PRECISION_FRAME, 28),
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 16), external("railcraft:ingot_steel", 0, 64)),
            new MachineRecipe("agricultural_tractor", IndustrialMachineKind.CAR_WORKSHOP,
                null, vehicleCrate("tractor"), new ItemStack(IndustrialCivilizationCore.PRECISION_FRAME, 18),
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 8), external("railcraft:ingot_steel", 0, 56)),
            new MachineRecipe("utility_cart", IndustrialMachineKind.CAR_WORKSHOP,
                null, vehicleCrate("golf_cart"), new ItemStack(IndustrialCivilizationCore.PRECISION_FRAME, 12),
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 4), external("railcraft:ingot_steel", 0, 32)),
            new MachineRecipe("scout_atv", IndustrialMachineKind.CAR_WORKSHOP,
                null, vehicleCrate("atv"), new ItemStack(IndustrialCivilizationCore.PRECISION_FRAME, 14),
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 6), external("railcraft:ingot_steel", 0, 40)),
            new MachineRecipe("combat_shotgun", IndustrialMachineKind.GUN_FACTORY,
                null, MarketEconomy.newCondition(external("techguns:combatshotgun", 0)),
                new ItemStack(IndustrialCivilizationCore.PRECISION_FRAME, 10),
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 6), external("railcraft:ingot_steel", 0, 32)),
            new MachineRecipe("automatic_rifle", IndustrialMachineKind.GUN_FACTORY,
                null, MarketEconomy.newCondition(external("techguns:m4", 0)),
                new ItemStack(IndustrialCivilizationCore.PRECISION_FRAME, 16),
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 10), external("ic2:itemmisc", 452, 8)),
            ...
            new MachineRecipe("emergency_continuity_core", IndustrialMachineKind.ROBOTIC_CELL,
                null, new ItemStack(IndustrialCivilizationCore.EMERGENCY_CONTINUITY_CORE),
                new ItemStack(IndustrialCivilizationCore.AI_CORE),
                new ItemStack(IndustrialCivilizationCore.CONTROL_PROCESSOR, 2),
                external("ic2:itemmisc", 452, 4)),
