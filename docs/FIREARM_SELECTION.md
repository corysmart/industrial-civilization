...
Techguns is All Rights Reserved and its upstream license forbids reuploading the mod. The Technic development pack therefore omits the Techguns JAR from its GitHub archive and uses ModDirector to retrieve CurseForge project `244201`, file `2958103`, from the author-hosted distribution path on first launch. The downloaded file must match SHA-256 `154d3d794cfd74252f2cec979a6e72f5187bb9c21897ed4b42f45771a0e558f7`.
