...
| `IndustrialCivilizationCore-0.9.0.jar` | First-party progression, research, factory salvage, machine, gate, quarry-mobility, civilization-service, freight-observability, AI-policy, and UI integration | local source | Compiled against Forge 14.23.5.2860 / Java 8 |
