...
Version 0.5.0 is a hidden internal alpha. The complete numbered campaign has passed live acceptance, while redistribution review, side-path acceptance, multiplayer QA, and final survival-balance work remain in progress.
