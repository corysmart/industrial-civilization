...
- ICBM Classic 6.5.5 is installed with duplicate parts normalized, IC2 MV/HV launch hardware, strategic-payload shortcut locks, and IC2 power-bridge guidance. Its bundled license expressly permits inclusion of the official unmodified JAR in a modpack.
- The hidden Technic development listing `Industrial Civilization: Astra` serves the full pack from a GitHub release while omitting Techguns from that archive. ModDirector retrieves the pinned author-hosted CurseForge file on first launch and rejects it unless SHA-256 `154d3d794cfd74252f2cec979a6e72f5187bb9c21897ed4b42f45771a0e558f7` matches.
