...
The Moon has no natural mobs, villages, or dungeons. Newly generated dungeon chunks are returned to lunar stone, while six compact heritage markers represent the Apollo surface flag sites; player-built bases are untouched. Mars permits only Galacticraft-native creatures before AI. Once an AI-age player generates new Mars terrain, sparse settlements, militia outposts, cities, roads, and utilities can appear. Earth equipment-market rules do not automatically apply there.
