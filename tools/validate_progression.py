...
check(quests.get("questSettings:10", {}).get("betterquesting:10", {}).get("pack_version:3") == 13, "Better Questing pack version includes loadable Mars-readiness, Martian Science, and render-safe wildcard quest icons")
