...
check(quests.get("questSettings:10", {}).get("betterquesting:10", {}).get("pack_version:3") == 11, "Better Questing pack version includes the loadable Mars-readiness advancement")
