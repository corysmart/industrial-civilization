...
check(quests.get("questSettings:10", {}).get("betterquesting:10", {}).get("pack_version:3") == 12, "Better Questing pack version includes loadable Mars-readiness and Martian Science advancements")
