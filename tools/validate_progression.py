...
check(quests.get("questSettings:10", {}).get("betterquesting:10", {}).get("pack_version:3") == 8, "Better Questing pack version includes active Oxygen Detector habitat gates")
